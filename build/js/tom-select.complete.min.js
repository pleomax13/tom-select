...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},m=e=>(e+"").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu,"\\$1"),b=(e,t)=>{var i=e[t]
if("function"==typeof i)return i
i&&!Array.isArray(i)&&(e[t]=[i])},O=(e,t)=>{if(Array.isArray(e))e.forEach(t)
else for(var i in e)e.hasOwnProperty(i)&&t(e[i],i)},y=(e,t)=>"number"==typeof e&&"number"==typeof t?e>t?1:e<t?-1:0:(e=c(e+"").toLowerCase())>(t=c(t+"").toLowerCase())?1:t>e?-1:0
...
let o=a[i]
if(null==o&&(o="desc"===l[i].direction?-1:1),s=o*y(c(n,e),c(n,t)))return s}return 0}:null}prepareSearch(e,t){const i={}
var s=Object.assign({},t)
if(b(s,"sort"),b(s,"sort_empty"),s.fields){b(s,"fields")
const e=[]
...
return t.innerHTML=e.trim(),t.firstChild}return document.querySelector(e)},I=e=>"string"==typeof e&&e.indexOf("<")>-1,A=(e,t)=>{var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)},C=(e,t)=>{Object.assign(e.style,t)},S=(e,...t)=>{var i=k(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},x=(e,...t)=>{var i=k(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},k=e=>{var t=[]
...
const H=e=>null==e?null:N(e),N=e=>"boolean"==typeof e?e?"1":"0":e+"",M=e=>(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),R=(e,t)=>{var i
...
t&&(p=t.textContent)}var u,h,g,v,f,m,b={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===d?(h=b.options,g={},v=1,f=e=>{var t=Object.assign({},e.dataset),i=s&&t[s]
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},m=(e,t)=>{var s=H(e.value)
if(null!=s&&(s||i.allowEmptyOption)){if(g.hasOwnProperty(s)){if(t){var a=g[s][l]
a?Array.isArray(a)?a.push(t):g[s][l]=[a,t]:g[s][l]=t}}else{var c=f(e)
c[n]=c[n]||e.textContent,c[o]=c[o]||s,c[r]=c[r]||e.disabled,c[l]=c[l]||t,c.$option=e,g[s]=c,h.push(c)}e.selected&&b.items.push(s)}},b.maxItems=e.hasAttribute("multiple")?null:1,O(e.children,(e=>{var t,i,s
"optgroup"===(u=e.tagName.toLowerCase())?((s=f(t=e))[a]=s[a]||t.getAttribute("label")||"",s[c]=s[c]||v++,s[r]=s[r]||t.disabled,b.optgroups.push(s),i=s[c],O(t.children,(e=>{m(e,i)}))):"option"===u&&m(e)}))):(()=>{const t=e.getAttribute(s)
if(t)b.options=JSON.parse(t),O(b.options,(e=>{b.items.push(e[o])}))
else{var r=e.value.trim()||""
if(!i.allowEmptyOption&&!r.length)return
const t=r.split(i.delimiter)
O(t,(e=>{const t={}
t[n]=e,t[o]=e,b.options.push(t)})),b.items=t}})(),Object.assign({},D,b,t)}var X=0
...
var u
if(S(r,n.wrapperClass,d,p),S(l,n.controlClass),W(r,l),S(a,n.dropdownClass,p),n.copyClassesToDropdown&&S(a,d),S(c,n.dropdownContentClass),W(a,c),_(n.dropdownParent||r).appendChild(a),I(n.controlInput)){u=_(n.controlInput)
...
T(n,{id:d}),T(a,{role:"combobox","aria-haspopup":"listbox","aria-expanded":"false","aria-controls":d,"aria-multiselectable":"true"})
...
S([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&T(l,{multiple:"multiple"}),t.placeholder&&T(i,{placeholder:t.placeholder}),!t.splitOn&&t.delimiter&&(t.splitOn=new RegExp("\\s*"+m(t.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=R(t.load,t.loadThrottle)),e.control_input.type=l.type,K(s,"mouseenter",(t=>{var i=L(t.target,"[data-selectable]",s)
...
n==i&&e.isOpen?t.stopPropagation():B(t,!0)},f=()=>{e.isOpen&&e.positionDropdown()},b=()=>{e.ignoreHover=!1}
K(document,"mousedown",v),K(window,"scroll",f,c),K(window,"resize",f,c),K(window,"mousemove",b,c),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("mousemove",b),window.removeEventListener("scroll",f),window.removeEventListener("resize",f),h&&h.removeEventListener("click",g)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,K(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),S(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),O(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
O(i,(e=>{e=H(e),this.options[e]?t.addItem(e):t.createItem(e)}))}}),0)}onKeyPress(e){var t=this
...
t.value!==e&&(t.value=e,A(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){z(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
i&&x(i,"last-active"),S(e,"active last-active"),t.trigger("item_select",e),-1==t.activeItems.indexOf(e)&&t.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),x(e,"active")}clearActiveItems(){x(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e,t=!0){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,T(this.focus_node,{"aria-activedescendant":e.getAttribute("id")}),T(e,{"aria-selected":"true"}),S(e,"active"),t&&this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
...
if(e!==n.lastQuery?(n.lastQuery=e,i=n.sifter.search(e,Object.assign(o,{score:s})),n.currentResults=i):i=Object.assign({},n.currentResults),n.settings.hideSelected)for(t=i.items.length-1;t>=0;t--){let e=H(i.items[t].id)
e&&-1!==n.items.indexOf(e)&&i.items.splice(t,1)}return i}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,c,d,p
const u={},h=[]
var g,v=this,f=v.inputValue(),m=v.search(f),b=null,y=v.settings.shouldOpen||!1,w=v.dropdown_content
for(v.activeOption&&(c=v.activeOption.dataset.value,d=v.activeOption.closest("[data-group]")),n=m.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(y=!0),t=0;t<n;t++){let e=m.items[t].id,n=v.options[e],l=v.getOption(e,!0)
for(v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(e)),o=n[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),T(l,{id:n.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),x(l,"active")),b||c!=e||(d?d.dataset.group===o.toString()&&(b=l):b=l),u[o].appendChild(l)}this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),O(h,(e=>{if(v.optgroups.hasOwnProperty(e)&&u[e].children.length){let t=document.createDocumentFragment(),i=v.render("optgroup_header",v.optgroups[e])
W(t,i),W(t,u[e])
...
return t&&(y=!0,w.insertBefore(t,w.firstChild)),t}
if(v.loading?_("loading"):v.settings.shouldLoad.call(v,f)?0===m.items.length&&_("no_results"):_("not_loading"),(a=v.canCreate(f))&&(p=_("option_create")),v.hasOptions=m.items.length>0||a,y){if(m.items.length>0){if(!b&&"single"===v.settings.mode&&v.items.length&&(b=v.getOption(v.items[0])),!w.contains(b)){let e=0
p&&!v.settings.addPrecedence&&(e=1),b=v.selectable()[e]}}else p&&(b=p)
e&&!v.isOpen&&(v.open(),v.scrollToOption(b,"auto")),v.setActiveOption(b)}else v.clearActiveOption(),e&&v.isOpen&&v.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e,t=!1){const i=this
if(Array.isArray(e))return i.addOptions(e,t),!1
const s=H(e[i.settings.valueField])
...
var s,n
const o=H(e),r=H(t[i.settings.valueField])
if(null===o)return
if(!i.options.hasOwnProperty(o))return
if("string"!=typeof r)throw new Error("Value must be set in option data")
const l=i.getOption(o),a=i.getItem(o)
if(t.$order=t.$order||i.options[o].$order,delete i.options[o],i.uncacheValue(r),i.options[r]=t,l){if(i.dropdown_content.contains(l)){const e=i._render("option",t)
j(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&S(s,"active"),j(a,s)),i.lastQuery=null}removeOption(e,t){const i=this
...
const i={}
O(this.options,((e,s)=>{t(e,s)&&(i[s]=this.options[s])})),this.options=this.sifter.items=i,this.lastQuery=null,this.trigger("option_clear")}clearFilter(e,t){return this.items.indexOf(t)>=0}getOption(e,t=!1){const i=H(e)
...
const n=this,o=n.settings.mode,r=H(e)
...
var t=H(e[n.settings.valueField])
...
function l(e,i,s){return e||(e=_('<option value="'+M(i)+'">'+M(s)+"</option>")),e!=n&&t.input.append(e),o.push(e),(e!=n||r>0)&&(e.selected=!0),e}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?l(n,"",""):t.items.forEach((e=>{if(i=t.options[e],s=i[t.settings.labelField]||"",o.includes(i.$option)){l(t.input.querySelector(`option[value="${U(e)}"]:not(:checked)`),e,s)}else i.$option=l(i.$option,e,s)}))}else t.input.value=t.getValue()
t.isSetup&&(e.silent||t.trigger("change",t.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,T(e.focus_node,{"aria-expanded":"true"}),e.refreshState(),C(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),C(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&t.hideInput()),t.isOpen=!1,T(t.focus_node,{"aria-expanded":"false"}),C(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
if(null==(s=n.settings.render[e].call(this,t,M)))return s
...
T(s,{"data-value":i}),"item"===e?(S(s,n.settings.itemClass),T(s,{"data-ts-item":""})):(S(s,n.settings.optionClass),T(s,{role:"option",id:t.$id}),n.options[i].$div=s)}return s}_render(e,t){const i=this.render(e,t)
...
var i=function(t){setTimeout((()=>{var i=t.querySelector("input")
const s=e.settings.selectedAriaMessage||"",n=e.settings.notSelectedAriaMessage||""
if(i instanceof HTMLInputElement){const e=t.getAttribute("data-aria-label")
t.classList.contains("selected")?(i.checked=!0,t.setAttribute("aria-label",`${e}${s?`, ${s},`:""}`)):(i.checked=!1,t.setAttribute("aria-label",`${e}${n?`, ${n},`:""}`))}}),1)}
e.hook("after","setupTemplates",(()=>{var t=e.settings.render.option
e.settings.render.option=(i,s)=>{var n=_(t.call(e,i,s)),o=document.createElement("input")
o.addEventListener("click",(function(e){B(e)})),o.type="checkbox",o.setAttribute("tabindex","-1"),o.setAttribute("aria-hidden","true"),n.setAttribute("data-aria-label",n.innerText)
const r=H(i[e.settings.valueField]),l=n.getAttribute("data-aria-label"),a=e.settings.selectedAriaMessage||"",c=e.settings.notSelectedAriaMessage||"",d=e.settings.checkboxIconHtml||""
return r&&e.items.indexOf(r)>-1?(o.checked=!0,n.setAttribute("aria-label",`${l}${a?`, ${a},`:""}`)):n.setAttribute("aria-label",`${l}${c?`, ${c},`:""}`),n.prepend(o),d&&o.insertAdjacentHTML("afterend",d),n}})),e.on("item_remove",(t=>{var s=e.getOption(t)
...
var i=this
if(t.append){var s='<a href="javascript:void(0)" class="'+t.className+'" tabindex="-1" title="'+M(t.title)+'">'+t.label+"</a>"
...
var i
c(t)?(i=e.render("loading_more",{query:t}))&&(i.setAttribute("data-selectable",""),o=i):t in r&&!n.querySelector(".no-results")&&(i=e.render("no_more_results",{query:t})),i&&(S(i,e.settings.optionClass),n.append(i))})),e.on("initialize",(()=>{a=Object.keys(e.options),n=e.dropdown_content,e.settings.render=Object.assign({},{loading_more:()=>'<div class="loading-more-results">Loading more results ... </div>',no_more_results:()=>'<div class="no-more-results">No more results</div>'},e.settings.render),n.addEventListener("scroll",(()=>{e.settings.shouldLoadMore.call(e)&&c(e.lastValue)&&(l||(l=!0,e.load.call(e,e.lastValue)))}))}))})),Y}))
