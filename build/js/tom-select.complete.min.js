...
T(n,{id:d}),T(a,{role:"combobox","aria-haspopup":"listbox","aria-expanded":"false","aria-controls":d,"aria-multiselectable":`${"multi"===e.settings.mode}`})
...
y(i,(e=>{e=H(e),this.options[e]?t.addItem(e):t.createItem(e)}))}}),0)}onKeyPress(e){var t=this
...
if(!v.settings.hideSelected){var _,I
const t=v.items.includes(e),i=null!=(_=this.settings)&&_.selectedAriaMessage?this.settings.selectedAriaMessage():"",s=null!=(I=this.settings)&&I.notSelectedAriaMessage?this.settings.notSelectedAriaMessage():""
...
var A=e=>{let t=v.render(e,{input:f})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(v.loading?A("loading"):v.settings.shouldLoad.call(v,f)?0===m.items.length&&A("no_results"):A("not_loading"),(a=v.canCreate(f))&&(p=A("option_create")),v.hasOptions=m.items.length>0||a,b){if(m.items.length>0){if(!O&&"single"===v.settings.mode&&v.items.length&&(O=v.getOption(v.items[0])),!w.contains(O)){let e=0
...
const i={}
y(this.options,((e,s)=>{t(e,s)&&(i[s]=this.options[s])})),this.options=this.sifter.items=i,this.lastQuery=null,this.trigger("option_clear")}clearFilter(e,t){return this.items.indexOf(t)>=0}getOption(e,t=!1){const i=H(e)
...
o.addEventListener("click",(function(e){B(e)})),o.type="checkbox",o.setAttribute("tabindex","-1"),o.setAttribute("aria-hidden","true")
const r=H(i[e.settings.valueField]),l=e.settings.checkboxIconHtml||""
return r&&e.items.indexOf(r)>-1&&(o.checked=!0),n.prepend(o),l&&o.insertAdjacentHTML("afterend",l),n}})),e.on("item_remove",(t=>{var s=e.getOption(t)
...
case 9:e.focus_node.tabIndex=-1}return e.onKeyDown.call(e,t)})),e.on("blur",(()=>{e.focus_node.tabIndex=e.isDisabled?-1:e.tabIndex})),e.on("option_active",(()=>{const t=e.control.getAttribute("aria-activedescendant")
T(e.control_input,{"aria-activedescendant":t})})),e.on("dropdown_open",(()=>{e.control_input.focus()}))
const t=e.onBlur
