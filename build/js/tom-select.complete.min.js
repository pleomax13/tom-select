...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},A=(e,t)=>{Object.assign(e.style,t)},S=(e,...t)=>{var i=k(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},x=(e,...t)=>{var i=k(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},k=e=>{var t=[]
...
var C=e=>{let t=v.render(e,{input:f})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(v.loading?C("loading"):v.settings.shouldLoad.call(v,f)?0===m.items.length&&C("no_results"):C("not_loading"),(a=v.canCreate(f))&&(p=C("option_create")),v.hasOptions=m.items.length>0||a,b){if(m.items.length>0){if(!O&&"single"===v.settings.mode&&v.items.length&&(O=v.getOption(v.items[0])),!w.contains(O)){let e=0
