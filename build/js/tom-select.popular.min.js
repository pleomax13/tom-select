...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},S=(e,t)=>{Object.assign(e.style,t)},C=(e,...t)=>{var i=F(t);(e=k(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},x=(e,...t)=>{var i=F(t);(e=k(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},F=e=>{var t=[]
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,t))s in o&&n.apply(e,o[s])},B=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},z=(e,t,i,s)=>{e.addEventListener(t,i,s)},K=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),Q=(e,t)=>{const i=e.getAttribute("id")
...
i&&(e.onOptionSelect(t,i),B(t,!0))})),z(r,"click",(t=>{var s=L(t.target,"[data-ts-item]",r)
s&&e.onItemSelect(t,s)?B(t,!0):""==i.value&&(e.onClick(),B(t,!0))})),z(a,"keydown",(t=>e.onKeyDown(t))),z(i,"keypress",(t=>e.onKeyPress(t))),z(i,"input",(t=>e.onInput(t))),z(a,"resize",(()=>e.positionDropdown()),c),z(a,"blur",(t=>e.onBlur(t))),z(a,"focus",(t=>e.onFocus(t))),z(i,"paste",(t=>e.onPaste(t)))
const v=t=>{const n=t.composedPath()[0]
if(!o.contains(n)&&!s.contains(n))return e.isFocused&&e.blur(),void e.inputState()
n==i&&e.isOpen?t.stopPropagation():B(t,!0)},m=()=>{e.isOpen&&e.positionDropdown()},y=()=>{e.ignoreHover=!1}
...
else{switch(e.keyCode){case 65:if(K($,e)&&""==t.control_input.value)return B(e),void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!K($,e)&&B(e)}}onInput(e){var t=this
...
t.value!==e&&(t.value=e,A(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){M(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
B(t)}else"click"===i&&K($,t)||"keydown"===i&&K("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
var A=e=>{let t=v.render(e,{input:m})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(v.loading?A("loading"):v.settings.shouldLoad.call(v,m)?0===f.items.length&&A("no_results"):A("not_loading"),(a=v.canCreate(m))&&(p=A("option_create")),v.hasOptions=f.items.length>0||a,b){if(f.items.length>0){if(!y&&"single"===v.settings.mode&&v.items.length&&(y=v.getOption(v.items[0])),!w.contains(y)){let e=0
...
return o.appendChild(r),z(r,"mousedown",(e=>{B(e,!0)})),z(r,"click",(e=>{B(e,!0),i.isLocked||i.shouldDelete([o],e)&&(i.removeItem(o),i.refreshOptions(!1),i.inputState())})),o}}))}})),X.define("restore_on_backspace",(function(e){const t=this,i=Object.assign({text:e=>e[t.settings.labelField]},e)
