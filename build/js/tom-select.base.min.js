...
return t.innerHTML=e.trim(),t.firstChild}return document.querySelector(e)},_=e=>"string"==typeof e&&e.indexOf("<")>-1,A=(e,t)=>{var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)},S=(e,t)=>{Object.assign(e.style,t)},C=(e,...t)=>{var i=x(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},F=(e,...t)=>{var i=x(t);(e=L(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},x=e=>{var t=[]
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,t))s in o&&n.apply(e,o[s])},z=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},K=(e,t,i,s)=>{e.addEventListener(t,i,s)},B=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),Q=(e,t)=>{const i=e.getAttribute("id")
...
else{switch(e.keyCode){case 65:if(B(j,e)&&""==t.control_input.value)return z(e),void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!B(j,e)&&z(e)}}onInput(e){var t=this
...
z(t)}else"click"===i&&B(j,t)||"keydown"===i&&B("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
if(!v.settings.hideSelected){var I,_
const t=v.items.includes(e),i=null!=(I=this.settings)&&I.selectedAriaMessage?this.settings.selectedAriaMessage():"",s=null!=(_=this.settings)&&_.notSelectedAriaMessage?this.settings.notSelectedAriaMessage():""
...
if(v.loading?A("loading"):v.settings.shouldLoad.call(v,m)?0===f.items.length&&A("no_results"):A("not_loading"),(a=v.canCreate(m))&&(p=A("option_create")),v.hasOptions=f.items.length>0||a,w){if(f.items.length>0){if(!y&&"single"===v.settings.mode&&v.items.length&&(y=v.getOption(v.items[0])),!b.contains(y)){let e=0
